...
export default function Intro() {
  return (
    <div className='px-6 py-12 bg-slate-50 dark:bg-slate-950'>
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-4 items-center space-y-5 lg:space-y-0 justify-center gap-3">
